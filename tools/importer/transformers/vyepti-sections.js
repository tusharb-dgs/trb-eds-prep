 ...
 * Inserts <hr> between the 6 template sections and a Section Metadata block
 * for the styled section (rc5 = powder-blue, .how-vyepti-section).
 * Selectors come from tools/importer/page-templates.json section.selector,
 * all verified against migration-work/cleaned.html.
 *
 * Both hooks are used deliberately: breaks are inserted in beforeTransform
 * (while every section element still exists, before parsers replace them),
 * and Section Metadata is inserted in afterTransform anchored to a marker <hr>.
 */
