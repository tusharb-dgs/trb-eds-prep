/**
 * Quote carousel: a swipable set of testimonial slides. Each slide pairs a
 * patient image with a quote, attribution and disclaimer.
 *
 * Expected authored structure: one row per slide, 2 cells:
 *   cell 1 = patient image, cell 2 = quote + attribution + disclaimer.
 * A single slide renders without navigation controls.
 */

// Static control labels (this project's aem.js has no fetchPlaceholders helper).
const LABELS = {
  carousel: 'Carousel',
